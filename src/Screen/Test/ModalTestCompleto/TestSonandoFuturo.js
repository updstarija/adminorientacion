...
const TestSonandoFuturo = (props) => {
  ...
  return (
    <Fragment>
      ...
      {preguntas[2].otro1 != "" ? (
        <p>Resp Otro 1: {preguntas[2].otro1}</p>
      ) : null}
      {preguntas[2].otro2 != "" ? (
        <p>Resp Otro 2: {preguntas[2].otro2}</p>
      ) : null}
      ...
      <p>Resp: {preguntas[4].respuesta4}</p>

      {/* Pregunta6*/}
      <strong>{preguntas[5].texto}</strong>
      <p>Resp: {preguntas[5].respuesta}</p>
      {preguntas[5].otro != "" ? <p>Resp Otro: {preguntas[5].otro}</p> : null}

      {/* Pregunta7*/}
      <strong>{preguntas[6].texto}</strong>
      <p>Resp: {preguntas[6].respuesta1}</p>
      <p>Resp: {preguntas[6].respuesta2}</p>
      <p>Resp: {preguntas[6].respuesta3}</p>
      {preguntas[6].otro1 != "" ? <p>Resp Otro: {preguntas[6].otro1}</p> : null}
      {preguntas[6].otro2 != "" ? <p>Resp Otro: {preguntas[6].otro2}</p> : null}
      {preguntas[6].otro3 != "" ? <p>Resp Otro: {preguntas[6].otro3}</p> : null}
