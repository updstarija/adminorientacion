...
const CompletoPreguntasComplementarias = (props) => {
  ...
  return (
    <Fragment>
      <h3 className="strong bg-danger text-light">Test 4 Preguntas Complementarias </h3>
      ...
      />
      <ContendorRespSiNo
        pregunta='Si tengo seguro de salud'
        respuesta= {`${preguntas[5].respuesta8}`}
      />
      <ContendorRespSiNo
        pregunta='Está lejos de mi familia'
      ...
      />
      <ContendorRespSiNo
        pregunta='Cumplir turnos de trabajo'
        respuesta= {`${preguntas[5].respuesta13}`}
      />
      <ContendorRespSiNo
        pregunta='Me capaciten continuamente'
      ...
      <strong>Pregunta 6. Otros trabajos</strong>
      <br/>
      ...
      <table className="table">
        ...
        <tbody>
          <tr>
            <td>{preguntas[6].respuestaSi1}</td>
            <td>{preguntas[6].respuestaNo1}</td>
          </tr>
          <tr>
            <td>{preguntas[6].respuestaSi2}</td>
            <td>{preguntas[6].respuestaNo2}</td>
          </tr>
          <tr>
            <td>{preguntas[6].respuestaSi3}</td>
            <td>{preguntas[6].respuestaNo3}</td>
          </tr>
          <tr>
            <td>{preguntas[6].respuestaSi4}</td>
            <td>{preguntas[6].respuestaNo4}</td>
          </tr>
          <tr>
            <td>{preguntas[6].respuestaSi5}</td>
            <td>{preguntas[6].respuestaNo5}</td>
          </tr>
        ...
        <div className='row border border-black mx-3'>
          ...
          <div className='col-3'>
            <FontAwesomeIcon 
              ...
              style={{color:respuesta == 'Si' ? 'rgba(0,195,0,1)' : 'rgba(195,0,0,1)' }}
            />
