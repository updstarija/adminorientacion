...
const ModalRevisarTest = (props) => {
  ...
  const { Sesion = {}, buttonLabel, className, test } = props;

  const { resumen = {}, resultados_carreras = [], Id } = test;
  let { test1 = {}, test2 = {}, test3 = {}, test4 = {} } = resumen;
  ...
  return (
    <div className="animate__animated animate__swing">
      <FontAwesomeIcon
        ...
        style={{
          backgroundColor: props.Revisado ? "rgba(180,180,250,1)" : undefined,
        }}
      />
      <Modal
        size="xl"
        ...
        <ModalBody>
          <div className="container">
            ...
            <TestAptitudes
              ...
              resultados_carreras={resultados_carreras}
            />
