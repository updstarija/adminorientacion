  ...
  return (
    <Fragment>
      ...
      <div className="row px-3">
        ...
        <p>
          {" "}
          &nbsp; 1. ¿En qué trabajo te imaginas desempeñándote? Indica uno o
          varios si estás indeciso/a.
        </p>
      </div>
      ...
      <div className="row px-3">
        ...
        <p>
          &nbsp; ¿En qué otros trabajos imaginas poder desempeñarte si tendrías
          la posibilidad de aprenderlos y cuáles no aceptarías para nada?
        </p>
      </div>
      <div
        style={{
          ...
          <thead className="thead-light">
            <tr>
              <th style={{ width: "50%" }} scope="col">
                Trabajos que sí aceptaría
              </th>
              <th style={{ width: "50%" }} scope="col">
                Trabajos que no aceptaría
              </th>
            </tr>
          </thead>
          <tbody>
