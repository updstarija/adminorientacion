...
import {faBell,faUserTie,faWindowClose,faEye} from '@fortawesome/free-solid-svg-icons'
...
//   console.log(test1)
  ...
  return (
    <div className='animate__animated animate__swing'>
      <FontAwesomeIcon icon={faEye} onClick={toggle} className='IconosToggleModal'/>
      <Modal size='xl' isOpen={modal} toggle={toggle} className='animate__animated animate__swing'>
        <ModalHeader  toggle={toggle}  >Test Compelto</ModalHeader>
